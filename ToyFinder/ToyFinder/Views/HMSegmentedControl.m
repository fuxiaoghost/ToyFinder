...
@property (nonatomic, retain) CALayer *selectedSegmentLayer;
...
@synthesize selectionIndicatorColor;
@synthesize selectedSegmentLayer;
...
- (void) dealloc{
    ...
    self.selectionIndicatorColor = nil;
    self.selectedSegmentLayer = nil;
    [super dealloc];
}
