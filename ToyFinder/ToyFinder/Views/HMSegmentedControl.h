...
@property (nonatomic, retain) UIFont *font; // default is [UIFont fontWithName:@"Avenir-Light" size:19.0f]
@property (nonatomic, retain) UIColor *textColor; // default is [UIColor blackColor]
@property (nonatomic, retain) UIColor *backgroundColor; // default is [UIColor whiteColor]
@property (nonatomic, retain) UIColor *selectionIndicatorColor; // default is 52, 181, 229
