...
@synthesize url, delegate, connection, imageData, userInfo, lowPriority, progressive, contentLength;
...
- (void)connection:(NSURLConnection *)aConnection didReceiveData:(NSData *)data
{
    ...
    if ([delegate respondsToSelector:@selector(imageDownloader:didChangedProgress:)]) {
        [delegate imageDownloader:self didChangedProgress:[imageData length]/(expectedSize + 0.0)];
    }
